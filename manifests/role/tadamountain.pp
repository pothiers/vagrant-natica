...
notify {"DBG: client loading manifests/role/tadamountain.pp":}
...
class role::tadamountain {
  ...
  #include ::profile::tada::common
  #include ::profile::tada::mountaindirs
...
##############################################################################
##############################################################################
### TEMPORARY (from old style); to be replaced with cleaner version above
### 
